...
export default async function handler(req, res) {
  ...
  const SUPABASE_URL = process.env.SUPABASE_URL || "https://nzekamsqsjvfeqfhdoht.supabase.co";
  const SUPABASE_ANON_KEY = process.env.SUPABASE_ANON_KEY || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im56ZWthbXNxc2p2ZmVxZmhkb2h0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzYyOTQ3MzUsImV4cCI6MjA5MTg3MDczNX0.Y8gN7n8HQybNWWVUZF-C1HJ6GaRmHcP2bcanF8NBJvg";
